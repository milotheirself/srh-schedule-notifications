...
//   const whenClose = ({ clean, force }) => {
//     if (clean)
//       try {
//         workerRequest.disconnectedCallback();
//         workerStorage.disconnectedCallback();
//         workerPublish.disconnectedCallback();
//       } catch (err) {
//         console.error(err);
//       }
...
//   process.on('exit', whenClose.bind(null, { clean: true }));
//   process.on('SIGINT', whenClose.bind(null, { force: true }));
//   process.on('SIGUSR1', whenClose.bind(null, { force: true }));
//   process.on('SIGUSR2', whenClose.bind(null, { force: true }));
// })();
