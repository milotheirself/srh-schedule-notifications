const resolve = () => {
  try {
    ...
    document.querySelector('center').setAttribute('style', 'padding: 20px; margin: -20px 0px 0px;');

    // ?
    const wid = Math.max(840, document.querySelector('center > table').offsetWidth + 40);
    const hei = document.querySelector('body').scrollHeight;
